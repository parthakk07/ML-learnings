...
# %%
patients_df["assigned_sex"] = patients_df["assigned_sex"].astype("str")
patients_df["birthdate"] = patients_df["birthdate"].astype("datetime64[ns]")
...
# %%
patients_df.loc[patients_df["weight"] == 48.8, "weight"] = patients_df["weight"].mean()
